...
void main(){gl_Position=position;}`;
    ...
    render(now = 0) {
      ...
      gl.clearColor(0.0196, 0.0196, 0.0353, 1); // GhostVote void (#050509)
  ...
  useEffect(() => {
    ...
    if (rendererRef.current.test(ghostVoteShaderSource) === null) {
      rendererRef.current.updateShader(ghostVoteShaderSource);
    }
...
// site's deep-space obsidian base (#050509), matching styles.css.
const ghostVoteShaderSource = `#version 300 es
precision highp float;
out vec4 O;
